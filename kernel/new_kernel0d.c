...
typedef struct _Eh {
    ...
    routings;
    handler;                                           /* line 27 */
    reset_instance_data;                               /* line 28 */
    finject;                                           /* line 29 */
    stop;                                              /* line 30 */
    instance_data;                                     /* line 31 *//*  arg needed for probe support  *//* line 32 */
    arg;                                               /* line 33 */
    state;                                             /* line 34 */
    special;                                           /* line 35 *//*  bootstrap debugging *//* line 36 */
    kind; /*  enum { container, leaf, } */             /* line 37 *//* line 38 */
} Eh;
Eh fresh_Eh () {
    Eh *self;
    ...
    self->handler =  NULL;                             /* line 27 */
    self->reset_instance_data =  NULL;                 /* line 28 */
    self->finject =  NULL;                             /* line 29 */
    self->stop =  NULL;                                /* line 30 */
    self->instance_data =  NULL;                       /* line 31 *//*  arg needed for probe support  *//* line 32 */
    self->arg =  "";                                   /* line 33 */
...
int  load_errors =  True                               /* line 1 */;
int  runtime_errors =  True                            /* line 2 */;/* line 3 */
void load_error (s) {
                                                       /* line 4 */
    static load_errors                                 /* line 5 */
    external print ( s, file=sys.stderr)               /* line 6 */
    external                                           /* line 7 */
    load_errors =  True;                               /* line 8 *//* line 9 *//* line 10 */}

void runtime_error (s) {
                                                       /* line 11 */
    static runtime_errors                              /* line 12 */
    external print ( s, file=sys.stderr)               /* line 13 */
    external exit (1)                                  /* line 14 */
...
void start_bare (part_name,palette,env) {
    ...
    part = get_component_instance ( palette, part_name, NULL)/* line 61 */
...
void inject (part,port,payload) {
    ...
    if not  load_errors:                               /* line 72 */
        ...
        external exit (1)                              /* line 80 *//* line 81 *//* line 82 *//* line 83 */}

void finalize (part) {
                                                       /* line 84 */
    external print (deque_to_json ( part.outq))        /* line 85 *//* line 86 *//* line 87 */}
